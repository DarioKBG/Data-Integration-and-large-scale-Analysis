...
def load_all_timetables(base_path="timetable_changes_compressed"):
    all_rows = []
...
if __name__ == "__main__":
    ...
    df = load_all_timetables("timetable_changes_compressed")
    #print(df.head())
    ...
    df.to_sql("trains_tc", db_engine, index=False, if_exists="replace")
